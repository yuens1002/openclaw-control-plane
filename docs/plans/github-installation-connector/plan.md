...
the **profile repo** (`openClaw-CoT-agency-profile`, private) owns the
*content* — [issue #4](https://github.com/dev-yuen-agency/openclaw-cot-agency-profile/issues/4)'s
...
- No read of, or coupling to, `openClaw-CoT-agency-profile`'s schema or
...
- No change to `openClaw-CoT-agency-profile` (issue #4's own repo).

## Handoff note

An earlier planning pass in this session mistakenly started this same
work in `openClaw-CoT-agency-profile` (branch `feat/github-installation-connector`
