...
| AC-DOCS-001 | `docs/architecture.md:22-30` | ✓ | States "not yet wired," cross-references both `[private-repo]#4` and the plan. See Docs Drift below for a gap this AC's own wording ("or a dedicated doc") didn't force a check of. |
