...
CREATE TABLE runtime_records (
  ...
  schema_ref text NOT NULL,
  operation_type text,
  operation_schema_version integer CHECK (operation_schema_version > 0),
...
SELECT
  ...
  NULL::integer AS operation_schema_version,
  jsonb_build_object(
...
INSERT INTO runtime_records
  (record_id, stream_id, record_sequence, kind, type, schema_version, schema_ref,
   operation_type, operation_schema_version, command_context, authenticated_principal_ref, effective_actor,
